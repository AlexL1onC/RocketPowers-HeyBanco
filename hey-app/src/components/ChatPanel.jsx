...
import { INITIAL_MESSAGES, BOT_REPLIES } from '../data/mockData';
...
export default function ChatPanel() {
  ...
  const QUICK = ['¿Cuánto ahorré este mes?', '¿Cómo mejoro mi score?', 'Ver mi historial'];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={e => (e.currentTarget.style.background = 'var(--hey-orange-dark)')}
          onMouseLeave={e => (e.currentTarget.style.background = 'var(--hey-orange)')}
        >↑</button>
      </div>
