  ...
  if (loading) {
    return (
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', flex: 1, overflowY: 'auto' }}>
        <div style={{ height: 11, width: 140, background: '#E8E5DF', borderRadius: 4, marginBottom: 16 }} />
        {[0, 1, 2].map(i => (
          <div key={i} style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
              <div style={{ height: 13, width: 120, background: '#E8E5DF', borderRadius: 4 }} />
              <div style={{ height: 12, width: 80, background: '#E8E5DF', borderRadius: 4 }} />
            </div>
            <div style={{ height: 6, background: 'var(--bg-secondary)', borderRadius: 3, overflow: 'hidden' }}>
              <div style={{ height: '100%', width: '60%', background: '#E8E5DF', borderRadius: 3 }} />
            </div>
            <div style={{ height: 11, width: 80, background: '#E8E5DF', borderRadius: 4, marginTop: 4 }} />
          </div>
        ))}
        <div style={{ height: 36, background: '#E8E5DF', borderRadius: 'var(--radius-sm)', marginTop: 4, animation: 'pulse 1.5s ease infinite' }} />
